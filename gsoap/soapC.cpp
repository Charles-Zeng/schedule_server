...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.8.45 2017-04-12 03:02:20 GMT")
...
{	(void)type;
	...
	case SOAP_TYPE_PointerTo_ns1__FaceService:
		return soap_in_PointerTo_ns1__FaceService(soap, NULL, NULL, "ns1:FaceService");
	...
	*type = 0;
	...
	{	const char *t = soap->type;
		...
		t = soap->tag;
		if (!soap_match_tag(soap, t, "ns1:FaceServiceResponse"))
		{	*type = SOAP_TYPE__ns1__FaceServiceResponse;
			return soap_in__ns1__FaceServiceResponse(soap, NULL, NULL, NULL);
		}
		if (!soap_match_tag(soap, t, "ns1:FaceService"))
		{	*type = SOAP_TYPE__ns1__FaceService;
			return soap_in__ns1__FaceService(soap, NULL, NULL, NULL);
		}
#ifndef WITH_NOIDREF
	}
#endif
...
{	(void)tag;
	...
	case SOAP_TYPE__ns1__FaceServiceResponse:
		return ((_ns1__FaceServiceResponse *)ptr)->soap_out(soap, "ns1:FaceServiceResponse", id, "");
	case SOAP_TYPE__ns1__FaceService:
		return ((_ns1__FaceService *)ptr)->soap_out(soap, "ns1:FaceService", id, "");
	case SOAP_TYPE_xsd__unsignedShort:
	...
	case SOAP_TYPE_PointerTo_ns1__FaceService:
		return soap_out_PointerTo_ns1__FaceService(soap, tag, id, (_ns1__FaceService *const*)ptr, "ns1:FaceService");
	case SOAP_TYPE_wstring:
...
SOAP_FMAC3 void SOAP_FMAC4 soap_markelement(struct soap *soap, const void *ptr, int type)
{
	...
	case SOAP_TYPE_ns3__char__:
		...
		break;
	case SOAP_TYPE__ns1__FaceServiceResponse:
		((_ns1__FaceServiceResponse *)ptr)->soap_serialize(soap);
		break;
	case SOAP_TYPE__ns1__FaceService:
		((_ns1__FaceService *)ptr)->soap_serialize(soap);
		break;
	case SOAP_TYPE_xsd__unsignedShort:
	...
	case SOAP_TYPE_xsd__anyType:
		...
		break;
	case SOAP_TYPE___ns1__FaceService:
		soap_serialize___ns1__FaceService(soap, (const struct __ns1__FaceService *)ptr);
		break;
	case SOAP_TYPE_PointerTo_ns1__FaceService:
		soap_serialize_PointerTo_ns1__FaceService(soap, (_ns1__FaceService *const*)ptr);
		break;
	case SOAP_TYPE_wstring:
...
{	(void)type;
	...
	case SOAP_TYPE__ns1__FaceService:
		return (void*)soap_instantiate__ns1__FaceService(soap, -1, type, arrayType, n);
	case SOAP_TYPE__ns1__FaceServiceResponse:
		return (void*)soap_instantiate__ns1__FaceServiceResponse(soap, -1, type, arrayType, n);
	case SOAP_TYPE___ns1__FaceService:
		return (void*)soap_instantiate___ns1__FaceService(soap, -1, type, arrayType, n);
#ifndef WITH_NOGLOBAL
...
{	switch (p->type)
	...
	case SOAP_TYPE__ns1__FaceService:
		if (p->size < 0)
			SOAP_DELETE(static_cast<_ns1__FaceService*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<_ns1__FaceService*>(p->ptr));
		break;
	case SOAP_TYPE__ns1__FaceServiceResponse:
		if (p->size < 0)
			SOAP_DELETE(static_cast<_ns1__FaceServiceResponse*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<_ns1__FaceServiceResponse*>(p->ptr));
		break;
	case SOAP_TYPE___ns1__FaceService:
		if (p->size < 0)
			SOAP_DELETE(static_cast<struct __ns1__FaceService*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<struct __ns1__FaceService*>(p->ptr));
		break;
#ifndef WITH_NOGLOBAL
	case SOAP_TYPE_SOAP_ENV__Header:
		if (p->size < 0)
...
SOAP_FMAC3 void SOAP_FMAC4 soap_finsert(struct soap *soap, int t, int tt, void *p, size_t index, const void *q, void **x)
{
	...
	case SOAP_TYPE_ns3__guid__:
		...
		*(ns3__guid__*)p = *(ns3__guid__*)q;
		break;
	case SOAP_TYPE__ns1__FaceService:
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copy _ns1__FaceService type=%d location=%p object=%p\n", t, p, q));
		*(_ns1__FaceService*)p = *(_ns1__FaceService*)q;
		break;
	case SOAP_TYPE__ns1__FaceServiceResponse:
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copy _ns1__FaceServiceResponse type=%d location=%p object=%p\n", t, p, q));
		*(_ns1__FaceServiceResponse*)p = *(_ns1__FaceServiceResponse*)q;
		break;
	case SOAP_TYPE___ns1__FaceService:
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copy struct __ns1__FaceService type=%d location=%p object=%p\n", t, p, q));
		*(struct __ns1__FaceService*)p = *(struct __ns1__FaceService*)q;
		break;
#ifndef WITH_NOGLOBAL
	case SOAP_TYPE_SOAP_ENV__Header:
...
SOAP_FMAC3 std::wstring * SOAP_FMAC4 soap_in_ns3__duration(struct soap *soap, const char *tag, std::wstring *s, const char *type)
{
	...
	{	wchar_t *t;
		...
		if (s)
		{	if (!(t = soap_wstring_in(soap, 1, 0, -1, "\\-?P(\\d*D)?(T(\\d*H)?(\\d*M)?(\\d*(\\.\\d*)?S)?)?")))
				return NULL;
			s->assign(t);
		}
	}
...
void _ns1__FaceServiceResponse::soap_default(struct soap *soap)
{
	this->soap = soap;
	this->_ns1__FaceServiceResponse::FaceServiceResult = NULL;
	/* transient soap skipped */
}

void _ns1__FaceServiceResponse::soap_serialize(struct soap *soap) const
{
	(void)soap; /* appease -Wall -Werror */
#ifndef WITH_NOIDREF
	soap_serialize_wstring(soap, (wchar_t*const*)&this->_ns1__FaceServiceResponse::FaceServiceResult);
#endif
}

int _ns1__FaceServiceResponse::soap_out(struct soap *soap, const char *tag, int id, const char *type) const
{
	return soap_out__ns1__FaceServiceResponse(soap, tag, id, this, type);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns1__FaceServiceResponse(struct soap *soap, const char *tag, int id, const _ns1__FaceServiceResponse *a, const char *type)
{
	(void)soap; (void)tag; (void)id; (void)a; (void)type; /* appease -Wall -Werror */
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE__ns1__FaceServiceResponse), type))
		return soap->error;
	if (a->FaceServiceResult)
		soap_element_result(soap, "ns1:FaceServiceResult");
	if (soap_out_wstring(soap, "ns1:FaceServiceResult", -1, (wchar_t*const*)&a->_ns1__FaceServiceResponse::FaceServiceResult, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}

void *_ns1__FaceServiceResponse::soap_in(struct soap *soap, const char *tag, const char *type)
{	return soap_in__ns1__FaceServiceResponse(soap, tag, this, type);
}

SOAP_FMAC3 _ns1__FaceServiceResponse * SOAP_FMAC4 soap_in__ns1__FaceServiceResponse(struct soap *soap, const char *tag, _ns1__FaceServiceResponse *a, const char *type)
{
	(void)tag; (void)type; /* appease -Wall -Werror */
	if (soap_element_begin_in(soap, tag, 0, NULL))
		return NULL;
	a = (_ns1__FaceServiceResponse *)soap_id_enter(soap, soap->id, a, SOAP_TYPE__ns1__FaceServiceResponse, sizeof(_ns1__FaceServiceResponse), soap->type, soap->arrayType, soap_instantiate, soap_fbase);
	if (!a)
		return NULL;
	if (soap->alloced && soap->alloced != SOAP_TYPE__ns1__FaceServiceResponse)
	{	soap_revert(soap);
		*soap->id = '\0';
		return (_ns1__FaceServiceResponse *)a->soap_in(soap, tag, type);
	}
	if (soap->alloced)
		a->soap_default(soap);
	size_t soap_flag_FaceServiceResult1 = 1;
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_FaceServiceResult1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in_wstring(soap, "ns1:FaceServiceResult", (wchar_t**)&a->_ns1__FaceServiceResponse::FaceServiceResult, "xsd:string"))
				{	soap_flag_FaceServiceResult1--;
					continue;
				}
			soap_check_result(soap, "ns1:FaceServiceResult");
	...
	{	a = (_ns1__FaceServiceResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE__ns1__FaceServiceResponse, SOAP_TYPE__ns1__FaceServiceResponse, sizeof(_ns1__FaceServiceResponse), 0, soap_finsert, soap_fbase);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC1 _ns1__FaceServiceResponse * SOAP_FMAC2 soap_instantiate__ns1__FaceServiceResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate__ns1__FaceServiceResponse(%p, %d, %s, %s)\n", (void*)soap, n, type?type:"", arrayType?arrayType:""));
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	_ns1__FaceServiceResponse *p;
	size_t k = sizeof(_ns1__FaceServiceResponse);
	if (n < 0)
	{	p = SOAP_NEW(_ns1__FaceServiceResponse);
		if (p)
			((_ns1__FaceServiceResponse*)p)->soap = soap;
	}
	else
	{	p = SOAP_NEW_ARRAY(_ns1__FaceServiceResponse, n);
		k *= n;
		if (p)
			for (int i = 0; i < n; i++)
				((_ns1__FaceServiceResponse*)p)[i].soap = soap;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated _ns1__FaceServiceResponse location=%p n=%d\n", (void*)p, n));
	soap_link(soap, p, SOAP_TYPE__ns1__FaceServiceResponse, n, soap_fdelete);
	if (size)
		*size = k;
	return p;
}

int _ns1__FaceServiceResponse::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	if (soap_out__ns1__FaceServiceResponse(soap, tag ? tag : "ns1:FaceServiceResponse", -2, this, type))
		return soap->error;
	return soap_putindependent(soap);
}

void *_ns1__FaceServiceResponse::soap_get(struct soap *soap, const char *tag, const char *type)
{
	return soap_get__ns1__FaceServiceResponse(soap, this, tag, type);
}

SOAP_FMAC3 _ns1__FaceServiceResponse * SOAP_FMAC4 soap_get__ns1__FaceServiceResponse(struct soap *soap, _ns1__FaceServiceResponse *p, const char *tag, const char *type)
{
	if ((p = soap_in__ns1__FaceServiceResponse(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

void _ns1__FaceService::soap_default(struct soap *soap)
{
	this->soap = soap;
	this->_ns1__FaceService::type = NULL;
	this->_ns1__FaceService::json = NULL;
	/* transient soap skipped */
}

void _ns1__FaceService::soap_serialize(struct soap *soap) const
{
	(void)soap; /* appease -Wall -Werror */
#ifndef WITH_NOIDREF
	soap_serialize_wstring(soap, (wchar_t*const*)&this->_ns1__FaceService::type);
	soap_serialize_wstring(soap, (wchar_t*const*)&this->_ns1__FaceService::json);
#endif
}

int _ns1__FaceService::soap_out(struct soap *soap, const char *tag, int id, const char *type) const
{
	return soap_out__ns1__FaceService(soap, tag, id, this, type);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns1__FaceService(struct soap *soap, const char *tag, int id, const _ns1__FaceService *a, const char *type)
{
	(void)soap; (void)tag; (void)id; (void)a; (void)type; /* appease -Wall -Werror */
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE__ns1__FaceService), type))
		return soap->error;
	if (soap_out_wstring(soap, "ns1:type", -1, (wchar_t*const*)&a->_ns1__FaceService::type, ""))
		return soap->error;
	if (soap_out_wstring(soap, "ns1:json", -1, (wchar_t*const*)&a->_ns1__FaceService::json, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}

void *_ns1__FaceService::soap_in(struct soap *soap, const char *tag, const char *type)
{	return soap_in__ns1__FaceService(soap, tag, this, type);
}

SOAP_FMAC3 _ns1__FaceService * SOAP_FMAC4 soap_in__ns1__FaceService(struct soap *soap, const char *tag, _ns1__FaceService *a, const char *type)
{
	(void)tag; (void)type; /* appease -Wall -Werror */
	if (soap_element_begin_in(soap, tag, 0, NULL))
		return NULL;
	a = (_ns1__FaceService *)soap_id_enter(soap, soap->id, a, SOAP_TYPE__ns1__FaceService, sizeof(_ns1__FaceService), soap->type, soap->arrayType, soap_instantiate, soap_fbase);
	if (!a)
		return NULL;
	if (soap->alloced && soap->alloced != SOAP_TYPE__ns1__FaceService)
	{	soap_revert(soap);
		*soap->id = '\0';
		return (_ns1__FaceService *)a->soap_in(soap, tag, type);
	}
	if (soap->alloced)
		a->soap_default(soap);
	...
	if (soap->body && !*soap->href)
	{
		...
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_type1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in_wstring(soap, "ns1:type", (wchar_t**)&a->_ns1__FaceService::type, "xsd:string"))
				{	soap_flag_type1--;
					continue;
				}
			if (soap_flag_json1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in_wstring(soap, "ns1:json", (wchar_t**)&a->_ns1__FaceService::json, "xsd:string"))
				{	soap_flag_json1--;
					continue;
				}
			if (soap->error == SOAP_TAG_MISMATCH)
	...
	{	a = (_ns1__FaceService *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE__ns1__FaceService, SOAP_TYPE__ns1__FaceService, sizeof(_ns1__FaceService), 0, soap_finsert, soap_fbase);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC1 _ns1__FaceService * SOAP_FMAC2 soap_instantiate__ns1__FaceService(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate__ns1__FaceService(%p, %d, %s, %s)\n", (void*)soap, n, type?type:"", arrayType?arrayType:""));
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	_ns1__FaceService *p;
	size_t k = sizeof(_ns1__FaceService);
	if (n < 0)
	{	p = SOAP_NEW(_ns1__FaceService);
		if (p)
			((_ns1__FaceService*)p)->soap = soap;
	}
	else
	{	p = SOAP_NEW_ARRAY(_ns1__FaceService, n);
		k *= n;
		if (p)
			for (int i = 0; i < n; i++)
				((_ns1__FaceService*)p)[i].soap = soap;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated _ns1__FaceService location=%p n=%d\n", (void*)p, n));
	soap_link(soap, p, SOAP_TYPE__ns1__FaceService, n, soap_fdelete);
	if (size)
		*size = k;
	return p;
}

int _ns1__FaceService::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	if (soap_out__ns1__FaceService(soap, tag ? tag : "ns1:FaceService", -2, this, type))
		return soap->error;
	return soap_putindependent(soap);
}

void *_ns1__FaceService::soap_get(struct soap *soap, const char *tag, const char *type)
{
	return soap_get__ns1__FaceService(soap, this, tag, type);
}

SOAP_FMAC3 _ns1__FaceService * SOAP_FMAC4 soap_get__ns1__FaceService(struct soap *soap, _ns1__FaceService *p, const char *tag, const char *type)
{
	if ((p = soap_in__ns1__FaceService(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}
...
SOAP_FMAC3 void SOAP_FMAC4 soap_default___ns1__FaceService(struct soap *soap, struct __ns1__FaceService *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	a->ns1__FaceService = NULL;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___ns1__FaceService(struct soap *soap, const struct __ns1__FaceService *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
#ifndef WITH_NOIDREF
	soap_serialize_PointerTo_ns1__FaceService(soap, &a->ns1__FaceService);
#endif
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out___ns1__FaceService(struct soap *soap, const char *tag, int id, const struct __ns1__FaceService *a, const char *type)
{
	(void)soap; (void)tag; (void)id; (void)a; (void)type; /* appease -Wall -Werror */
	if (soap_out_PointerTo_ns1__FaceService(soap, "ns1:FaceService", -1, &a->ns1__FaceService, ""))
		return soap->error;
	return SOAP_OK;
}

SOAP_FMAC3 struct __ns1__FaceService * SOAP_FMAC4 soap_in___ns1__FaceService(struct soap *soap, const char *tag, struct __ns1__FaceService *a, const char *type)
{
	size_t soap_flag_ns1__FaceService = 1;
	short soap_flag;
	(void)tag; (void)type; /* appease -Wall -Werror */
	a = (struct __ns1__FaceService *)soap_id_enter(soap, "", a, SOAP_TYPE___ns1__FaceService, sizeof(struct __ns1__FaceService), NULL, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default___ns1__FaceService(soap, a);
		for (soap_flag = 0;; soap_flag = 1)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_ns1__FaceService && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_PointerTo_ns1__FaceService(soap, "ns1:FaceService", &a->ns1__FaceService, ""))
				{	soap_flag_ns1__FaceService--;
					continue;
				}
...
SOAP_FMAC1 struct __ns1__FaceService * SOAP_FMAC2 soap_instantiate___ns1__FaceService(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate___ns1__FaceService(%p, %d, %s, %s)\n", (void*)soap, n, type?type:"", arrayType?arrayType:""));
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	struct __ns1__FaceService *p;
	size_t k = sizeof(struct __ns1__FaceService);
	if (n < 0)
	{	p = SOAP_NEW(struct __ns1__FaceService);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct __ns1__FaceService, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct __ns1__FaceService location=%p n=%d\n", (void*)p, n));
	soap_link(soap, p, SOAP_TYPE___ns1__FaceService, n, soap_fdelete);
	if (size)
		*size = k;
	return p;
}

SOAP_FMAC3 int SOAP_FMAC4 soap_put___ns1__FaceService(struct soap *soap, const struct __ns1__FaceService *a, const char *tag, const char *type)
{
	if (soap_out___ns1__FaceService(soap, tag ? tag : "-ns1:FaceService", -2, a, type))
		return soap->error;
	return SOAP_OK;
}

SOAP_FMAC3 struct __ns1__FaceService * SOAP_FMAC4 soap_get___ns1__FaceService(struct soap *soap, struct __ns1__FaceService *p, const char *tag, const char *type)
{
	if ((p = soap_in___ns1__FaceService(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTo_ns1__FaceService(struct soap *soap, _ns1__FaceService *const*a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
#ifndef WITH_NOIDREF
	if (!soap_reference(soap, *a, SOAP_TYPE__ns1__FaceService))
		(*a)->soap_serialize(soap);
#endif
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTo_ns1__FaceService(struct soap *soap, const char *tag, int id, _ns1__FaceService *const*a, const char *type)
{
	id = soap_element_id(soap, tag, id, *a, NULL, 0, type, SOAP_TYPE__ns1__FaceService, NULL);
	if (id < 0)
		return soap->error;
	return (*a)->soap_out(soap, tag, id, (*a)->soap_type() == SOAP_TYPE__ns1__FaceService ? type : NULL);
}

SOAP_FMAC3 _ns1__FaceService ** SOAP_FMAC4 soap_in_PointerTo_ns1__FaceService(struct soap *soap, const char *tag, _ns1__FaceService **a, const char *type)
{
	(void)type; /* appease -Wall -Werror */
	if (soap_element_begin_in(soap, tag, 1, NULL))
		return NULL;
	if (!a)
		if (!(a = (_ns1__FaceService **)soap_malloc(soap, sizeof(_ns1__FaceService *))))
			return NULL;
	*a = NULL;
	if (!soap->null && *soap->href != '#')
	{	soap_revert(soap);
		if (!(*a = (_ns1__FaceService *)soap_instantiate__ns1__FaceService(soap, -1, soap->type, soap->arrayType, NULL)))
			return NULL;
		(*a)->soap_default(soap);
	...
	{	a = (_ns1__FaceService **)soap_id_lookup(soap, soap->href, (void**)a, SOAP_TYPE__ns1__FaceService, sizeof(_ns1__FaceService), 0, soap_fbase);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__FaceService(struct soap *soap, _ns1__FaceService *const*a, const char *tag, const char *type)
{
	if (soap_out_PointerTo_ns1__FaceService(soap, tag ? tag : "ns1:FaceService", -2, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 _ns1__FaceService ** SOAP_FMAC4 soap_get_PointerTo_ns1__FaceService(struct soap *soap, _ns1__FaceService **p, const char *tag, const char *type)
{
	if ((p = soap_in_PointerTo_ns1__FaceService(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}
