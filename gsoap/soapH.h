...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, NULL) || soap_put_ns3__char(soap, p, "ns3:char", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap->error;
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_connect(soap, URL, NULL) || soap_put_ns3__char(soap, p, "ns3:char", "") || soap_end_send(soap))
		return soap->error;
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || soap_read_ns3__char(soap, p))
		return soap->error;
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, NULL) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns3:guid", p->soap_type() == SOAP_TYPE_ns3__guid__ ? "" : NULL) || soap_end_send(soap))
		return soap->error;
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || soap_read_ns3__guid__(soap, p))
		return soap->error;
	return SOAP_OK;
}
...
#define soap_s2ns3__guid(soap, s, a) soap_s2stdwchar((soap), (s), (a), 0, -1, "[\\da-fA-F]{8}-[\\da-fA-F]{4}-[\\da-fA-F]{4}-[\\da-fA-F]{4}-[\\da-fA-F]{12}")
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, NULL) || soap_put_ns3__guid(soap, p, "ns3:guid", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap->error;
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_connect(soap, URL, NULL) || soap_put_ns3__guid(soap, p, "ns3:guid", "") || soap_end_send(soap))
		return soap->error;
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || soap_read_ns3__guid(soap, p))
		return soap->error;
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, NULL) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns3:duration", p->soap_type() == SOAP_TYPE_ns3__duration__ ? "" : NULL) || soap_end_send(soap))
		return soap->error;
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || soap_read_ns3__duration__(soap, p))
		return soap->error;
	return SOAP_OK;
}
...
inline void soap_default_ns3__duration(struct soap *soap, std::wstring *p)
{
	(void)soap; /* appease -Wall -Werror */
	p->erase();
}
...
#define soap_s2ns3__duration(soap, s, a) soap_s2stdwchar((soap), (s), (a), 0, -1, "\\-?P(\\d*D)?(T(\\d*H)?(\\d*M)?(\\d*(\\.\\d*)?S)?)?")
...
#define soap_new_ns3__duration soap_new_std__wstring
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, NULL) || soap_put_ns3__duration(soap, p, "ns3:duration", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap->error;
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_connect(soap, URL, NULL) || soap_put_ns3__duration(soap, p, "ns3:duration", "") || soap_end_send(soap))
		return soap->error;
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || soap_read_ns3__duration(soap, p))
		return soap->error;
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, NULL) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns3:char", p->soap_type() == SOAP_TYPE_ns3__char__ ? "" : NULL) || soap_end_send(soap))
		return soap->error;
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || soap_read_ns3__char__(soap, p))
		return soap->error;
	return SOAP_OK;
}
...
#ifndef SOAP_TYPE__ns1__FaceServiceResponse_DEFINED
#define SOAP_TYPE__ns1__FaceServiceResponse_DEFINED
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns1__FaceServiceResponse(struct soap*, const char*, int, const _ns1__FaceServiceResponse *, const char*);
SOAP_FMAC3 _ns1__FaceServiceResponse * SOAP_FMAC4 soap_in__ns1__FaceServiceResponse(struct soap*, const char*, _ns1__FaceServiceResponse *, const char*);
SOAP_FMAC1 _ns1__FaceServiceResponse * SOAP_FMAC2 soap_instantiate__ns1__FaceServiceResponse(struct soap*, int, const char*, const char*, size_t*);

inline _ns1__FaceServiceResponse * soap_new__ns1__FaceServiceResponse(struct soap *soap, int n = -1)
{
	return soap_instantiate__ns1__FaceServiceResponse(soap, n, NULL, NULL, NULL);
}

inline _ns1__FaceServiceResponse * soap_new_req__ns1__FaceServiceResponse(
	struct soap *soap)
{
	_ns1__FaceServiceResponse *_p = soap_new__ns1__FaceServiceResponse(soap);
	if (_p)
	{	_p->soap_default(soap);
	}
	return _p;
...
inline _ns1__FaceServiceResponse * soap_new_set__ns1__FaceServiceResponse(
	struct soap *soap,
	wchar_t *FaceServiceResult)
{
	...
	if (_p)
	{	_p->soap_default(soap);
		_p->_ns1__FaceServiceResponse::FaceServiceResult = FaceServiceResult;
	}
	return _p;
}

inline int soap_write__ns1__FaceServiceResponse(struct soap *soap, _ns1__FaceServiceResponse const*p)
{
	soap_free_temp(soap);
	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:FaceServiceResponse", p->soap_type() == SOAP_TYPE__ns1__FaceServiceResponse ? "" : NULL) || soap_end_send(soap))
		return soap->error;
	return SOAP_OK;
}

inline int soap_PUT__ns1__FaceServiceResponse(struct soap *soap, const char *URL, _ns1__FaceServiceResponse const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, NULL) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:FaceServiceResponse", p->soap_type() == SOAP_TYPE__ns1__FaceServiceResponse ? "" : NULL) || soap_end_send(soap))
		return soap->error;
	return SOAP_OK;
}

inline int soap_POST_send__ns1__FaceServiceResponse(struct soap *soap, const char *URL, _ns1__FaceServiceResponse const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, NULL) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:FaceServiceResponse", p->soap_type() == SOAP_TYPE__ns1__FaceServiceResponse ? "" : NULL) || soap_end_send(soap))
		return soap->error;
...
SOAP_FMAC3 _ns1__FaceServiceResponse * SOAP_FMAC4 soap_get__ns1__FaceServiceResponse(struct soap*, _ns1__FaceServiceResponse *, const char*, const char*);

inline int soap_read__ns1__FaceServiceResponse(struct soap *soap, _ns1__FaceServiceResponse *p)
{
	if (p)
	{	p->soap_default(soap);
		if (soap_begin_recv(soap) || soap_get__ns1__FaceServiceResponse(soap, p, NULL, NULL) == NULL || soap_end_recv(soap))
			return soap->error;
	}
	return SOAP_OK;
}

inline int soap_GET__ns1__FaceServiceResponse(struct soap *soap, const char *URL, _ns1__FaceServiceResponse *p)
{
	if (soap_GET(soap, URL, NULL) || soap_read__ns1__FaceServiceResponse(soap, p))
		return soap->error;
	return SOAP_OK;
}

inline int soap_POST_recv__ns1__FaceServiceResponse(struct soap *soap, _ns1__FaceServiceResponse *p)
{
	if (soap_read__ns1__FaceServiceResponse(soap, p) || soap_closesock(soap))
		return soap->error;
	return SOAP_OK;
}
#endif

#ifndef SOAP_TYPE__ns1__FaceService_DEFINED
#define SOAP_TYPE__ns1__FaceService_DEFINED
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns1__FaceService(struct soap*, const char*, int, const _ns1__FaceService *, const char*);
SOAP_FMAC3 _ns1__FaceService * SOAP_FMAC4 soap_in__ns1__FaceService(struct soap*, const char*, _ns1__FaceService *, const char*);
SOAP_FMAC1 _ns1__FaceService * SOAP_FMAC2 soap_instantiate__ns1__FaceService(struct soap*, int, const char*, const char*, size_t*);

inline _ns1__FaceService * soap_new__ns1__FaceService(struct soap *soap, int n = -1)
{
	return soap_instantiate__ns1__FaceService(soap, n, NULL, NULL, NULL);
}

inline _ns1__FaceService * soap_new_req__ns1__FaceService(
	struct soap *soap)
{
	_ns1__FaceService *_p = soap_new__ns1__FaceService(soap);
	if (_p)
	{	_p->soap_default(soap);
	}
	return _p;
...
inline _ns1__FaceService * soap_new_set__ns1__FaceService(
	struct soap *soap,
	wchar_t *type,
	wchar_t *json)
{
	...
	if (_p)
	{	_p->soap_default(soap);
		_p->_ns1__FaceService::type = type;
		_p->_ns1__FaceService::json = json;
	}
	return _p;
}

inline int soap_write__ns1__FaceService(struct soap *soap, _ns1__FaceService const*p)
{
	soap_free_temp(soap);
	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:FaceService", p->soap_type() == SOAP_TYPE__ns1__FaceService ? "" : NULL) || soap_end_send(soap))
		return soap->error;
	return SOAP_OK;
}

inline int soap_PUT__ns1__FaceService(struct soap *soap, const char *URL, _ns1__FaceService const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, NULL) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:FaceService", p->soap_type() == SOAP_TYPE__ns1__FaceService ? "" : NULL) || soap_end_send(soap))
		return soap->error;
	return SOAP_OK;
}

inline int soap_POST_send__ns1__FaceService(struct soap *soap, const char *URL, _ns1__FaceService const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, NULL) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:FaceService", p->soap_type() == SOAP_TYPE__ns1__FaceService ? "" : NULL) || soap_end_send(soap))
		return soap->error;
...
SOAP_FMAC3 _ns1__FaceService * SOAP_FMAC4 soap_get__ns1__FaceService(struct soap*, _ns1__FaceService *, const char*, const char*);

inline int soap_read__ns1__FaceService(struct soap *soap, _ns1__FaceService *p)
{
	if (p)
	{	p->soap_default(soap);
		if (soap_begin_recv(soap) || soap_get__ns1__FaceService(soap, p, NULL, NULL) == NULL || soap_end_recv(soap))
			return soap->error;
	}
	return SOAP_OK;
}

inline int soap_GET__ns1__FaceService(struct soap *soap, const char *URL, _ns1__FaceService *p)
{
	if (soap_GET(soap, URL, NULL) || soap_read__ns1__FaceService(soap, p))
		return soap->error;
	return SOAP_OK;
}

inline int soap_POST_recv__ns1__FaceService(struct soap *soap, _ns1__FaceService *p)
{
	if (soap_read__ns1__FaceService(soap, p) || soap_closesock(soap))
		return soap->error;
	return SOAP_OK;
}
#endif
...
#define soap_s2xsd__duration(soap, s, a) soap_s2stdwchar((soap), (s), (a), 0, -1, NULL)
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, NULL) || soap_put_std__wstring(soap, p, "string", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap->error;
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_connect(soap, URL, NULL) || soap_put_std__wstring(soap, p, "string", "") || soap_end_send(soap))
		return soap->error;
	return SOAP_OK;
}
...
#ifndef SOAP_TYPE___ns1__FaceService_DEFINED
#define SOAP_TYPE___ns1__FaceService_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_default___ns1__FaceService(struct soap*, struct __ns1__FaceService *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___ns1__FaceService(struct soap*, const struct __ns1__FaceService *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out___ns1__FaceService(struct soap*, const char*, int, const struct __ns1__FaceService *, const char*);
SOAP_FMAC3 struct __ns1__FaceService * SOAP_FMAC4 soap_in___ns1__FaceService(struct soap*, const char*, struct __ns1__FaceService *, const char*);
SOAP_FMAC1 struct __ns1__FaceService * SOAP_FMAC2 soap_instantiate___ns1__FaceService(struct soap*, int, const char*, const char*, size_t*);

inline struct __ns1__FaceService * soap_new___ns1__FaceService(struct soap *soap, int n = -1)
{
	return soap_instantiate___ns1__FaceService(soap, n, NULL, NULL, NULL);
}

inline struct __ns1__FaceService * soap_new_req___ns1__FaceService(
	struct soap *soap)
{
	struct __ns1__FaceService *_p = soap_new___ns1__FaceService(soap);
	if (_p)
	{	soap_default___ns1__FaceService(soap, _p);
	}
	return _p;
}

inline struct __ns1__FaceService * soap_new_set___ns1__FaceService(
	struct soap *soap,
	_ns1__FaceService *ns1__FaceService)
{
	...
	if (_p)
	{	soap_default___ns1__FaceService(soap, _p);
		_p->ns1__FaceService = ns1__FaceService;
	}
	return _p;
}
SOAP_FMAC3 int SOAP_FMAC4 soap_put___ns1__FaceService(struct soap*, const struct __ns1__FaceService *, const char*, const char*);

inline int soap_write___ns1__FaceService(struct soap *soap, struct __ns1__FaceService const*p)
{
	soap_free_temp(soap);
	if (soap_begin_send(soap) || (soap_serialize___ns1__FaceService(soap, p), 0) || soap_put___ns1__FaceService(soap, p, "-ns1:FaceService", "") || soap_end_send(soap))
			return soap->error;
	return SOAP_OK;
}

inline int soap_PUT___ns1__FaceService(struct soap *soap, const char *URL, struct __ns1__FaceService const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, NULL) || (soap_serialize___ns1__FaceService(soap, p), 0) || soap_put___ns1__FaceService(soap, p, "-ns1:FaceService", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap->error;
	return SOAP_OK;
}

inline int soap_POST_send___ns1__FaceService(struct soap *soap, const char *URL, struct __ns1__FaceService const*p)
{
	soap_free_temp(soap);
	if (soap_connect(soap, URL, NULL) || (soap_serialize___ns1__FaceService(soap, p), 0) || soap_put___ns1__FaceService(soap, p, "-ns1:FaceService", "") || soap_end_send(soap))
		return soap->error;
	return SOAP_OK;
}
SOAP_FMAC3 struct __ns1__FaceService * SOAP_FMAC4 soap_get___ns1__FaceService(struct soap*, struct __ns1__FaceService *, const char*, const char*);

inline int soap_read___ns1__FaceService(struct soap *soap, struct __ns1__FaceService *p)
{
	if (p)
	{	soap_default___ns1__FaceService(soap, p);
		if (soap_begin_recv(soap) || soap_get___ns1__FaceService(soap, p, NULL, NULL) == NULL || soap_end_recv(soap))
			return soap->error;
	}
	return SOAP_OK;
}

inline int soap_GET___ns1__FaceService(struct soap *soap, const char *URL, struct __ns1__FaceService *p)
{
	if (soap_GET(soap, URL, NULL) || soap_read___ns1__FaceService(soap, p))
		return soap->error;
	return SOAP_OK;
}

inline int soap_POST_recv___ns1__FaceService(struct soap *soap, struct __ns1__FaceService *p)
{
	if (soap_read___ns1__FaceService(soap, p) || soap_closesock(soap))
		return soap->error;
	return SOAP_OK;
}
#endif
...
#ifndef SOAP_TYPE_PointerTo_ns1__FaceService_DEFINED
#define SOAP_TYPE_PointerTo_ns1__FaceService_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTo_ns1__FaceService(struct soap*, _ns1__FaceService *const*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTo_ns1__FaceService(struct soap*, const char *, int, _ns1__FaceService *const*, const char *);
SOAP_FMAC3 _ns1__FaceService ** SOAP_FMAC4 soap_in_PointerTo_ns1__FaceService(struct soap*, const char*, _ns1__FaceService **, const char*);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__FaceService(struct soap*, _ns1__FaceService *const*, const char*, const char*);
SOAP_FMAC3 _ns1__FaceService ** SOAP_FMAC4 soap_get_PointerTo_ns1__FaceService(struct soap*, _ns1__FaceService **, const char*, const char*);
#endif
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, NULL) || soap_put_wstring(soap, p, "string", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap->error;
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_connect(soap, URL, NULL) || soap_put_wstring(soap, p, "string", "") || soap_end_send(soap))
		return soap->error;
	return SOAP_OK;
}
